@section('content')
                        ...
                        <div class="mb-2 form_box">
                            <input id="email" type="email" class="custom_input @error('email') is-invalid @enderror" name="email"  required autocomplete="email">
                            @error('email')
...
{{-- VERSIONE CORRETTA  --}}
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <div id="emailHelp" class="form-text text-white">Non condivideremo la tua mail con nessuno</div>
