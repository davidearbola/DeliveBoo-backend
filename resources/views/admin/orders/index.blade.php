    ...
    <div class="table-responsive rounded">
        <table class="table table-success text-center align-middle mb-0">
            ...
            <tbody>
                ...
                <!-- Modale delete -->
                <div class="modal fade" id="modal-{{ $singleOrder->id }}" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitle-{{ $singleOrder->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="{{ route('admin.orders.destroy', $singleOrder) }}" method="post" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                ...
                {{-- Modale info --}}
                <div class="modal fade" id="modal1-{{ $singleOrder->id }}" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitle-{{ $singleOrder->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalTitle-{{ $singleOrder->id }}">
                            ...
                            <div class="modal-body">
                                <p class="m-0"><span class="fw-bold">Nome cliente : </span><span>{{$singleOrder->name}}</span></p>
                                <p class="m-0"><span class="fw-bold">Telefono cliente : </span><span>{{$singleOrder->phone}}</span></p>
                                <p class="mb-3"><span class="fw-bold">Indirizzo cliente : </span><span>{{$singleOrder->address}}</span></p>
                                @foreach($singleOrder->products as $product)
                                    <p class="m-0">- {{ $product->pivot->name }} x {{ $product->pivot->quantity }}</p>
                                @endforeach
                            </div>
